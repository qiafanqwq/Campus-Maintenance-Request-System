...
import {addUserAPI2, pageRepairmanAPI, starOrStopAdminOrRepairmanAPI, updateUserAPI2} from '@/api/usersPageQuery.ts'
...
const QueryUsers = async () => {
  try{
    const response = await pageRepairmanAPI(UserPageQueryDTO)
    if (response.code === 1) {
